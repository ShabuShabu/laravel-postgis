...
return new class () extends Migration
{
    ...
    {
        Schema::create('continents', static function (Blueprint $table) {
            $table->identity(always: true)->primary();
            $table->text('name');
            $table->text('slug');
            $table->text('code');
            $table->text('hash');
            $table->bigInteger('area_km2')->storedAs(area());
        ...
        Schema::create('continent_timezone', static function (Blueprint $table) {
            $table->identity(always: true)->primary();
            ...
            $table->uniqueIndex(['continent_id', 'timezone_id']);
        });
    }
};
